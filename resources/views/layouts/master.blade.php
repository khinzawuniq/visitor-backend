...
<html lang="en">
	...
	<head><base href="">
		...
		<meta property="og:site_name" content="Visitor" />
					...
					<div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
						...
						<div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
							...
							<div class="text-dark order-2 order-md-1">
								...
								<a href="#" class="text-gray-800 text-hover-primary">{{date('Y')}} Empowered by Visitor. All Rights Reserved.</a>
							</div>
							<!--end::Copyright-->
						</div>
						<!--end::Container-->
		...
		<script>
			$(function() {
				...
				tinymce.init({
					...
					menubar: false,
					toolbar: ["styleselect | undo redo | cut copy paste | bold italic | link media image | alignleft aligncenter alignright alignjustify",
					"bullist numlist | outdent indent | blockquote subscript superscript | advlist | autolink | lists charmap | print preview | code"],
					plugins : "code image media link",
					image_title: true,
					relative_urls : false,
					remove_script_host : true,
					document_base_url : "{{url('') . '/storage/editor/'}}",
					automatic_uploads: true,
					media_live_embeds: true,
					images_upload_url: '{{url("/admin/editor-upload")}}',
